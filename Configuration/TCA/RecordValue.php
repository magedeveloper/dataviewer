...
$GLOBALS['TCA']['tx_dataviewer_domain_model_recordvalue'] = array(
	'ctrl' => $GLOBALS['TCA']['tx_dataviewer_domain_model_recordvalue']['ctrl'],
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, value_content, search, record, field',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, value_content, search, record, field, --div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access, starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
	'columns' => array(
		...
		'internal_position' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:dataviewer/Resources/Private/Language/locallang_db.xlf:tx_dataviewer_domain_model_recordvalue.internal_position',
			'config' => array(
				'type' => 'text',
				'cols' => 40,
				'rows' => 15,
