...
class RecordController extends AbstractController
{
	...
	public function listAction()
	{
        ...
        if($lifetime > 0)
        {
            // Try to retrieve cached content, only if cache lifetime was set to a value gt 0
            $content = \TYPO3\CMS\Frontend\Page\PageRepository::getHash($cacheIdentifier);
		...
		// Add the rendered output to the frontend cache
        if($lifetime > 0)
            \TYPO3\CMS\Frontend\Page\PageRepository::storeHash($cacheIdentifier, $rendered, "records", $lifetime);
